...
def test_eval_seg(test_root, gt_root, test_list, uniform_size, mean, batch_size):
    ...
    param_file = 'work_dir/snapshots/iter.00009000.parrots'
    ...
    # for i in range(0, 10, batch_size):
        ...
        pred = flow.data('upscore2').value().T
    ...
    print '>>>', 'per class acc:\n', c_acc 
    show_c_acc = ["{:.1f}".format(i*100) for i in c_acc]
    print '>>>', show_c_acc
    print '>>>', 'mean acc', np.nanmean(c_acc)
    ...
    print '>>>', 'per class IU:\n', iu
    show_iu = ["{:.1f}".format(i*100) for i in iu]
    print '>>>', show_iu
    print '>>>', 'mean IU', np.nanmean(iu)

def main_eval():
    test_eval_seg('/home/yhcao6/VOC_arg/JPEGImages/', '/home/yhcao6/VOC_arg/SegmentationClass_label/', '/home/yhcao6/VOC_arg/Lists/Img/val.txt', 480, np.array([104.00699, 116.66877, 122.67892]), 1)
